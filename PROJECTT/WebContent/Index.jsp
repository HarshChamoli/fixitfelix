...
<header>
  ...
  <a class="navbar-brand" href="Index.jsp">Fix-It Felix</a>
				...
				<ul class="rslides" id="slider3">
					<li>
						<div class="slider-img">
							...
							<div class="text">
								  <p style="color:white;font-size:34px;">We Provide The Best Home Service For Making Your Home Shine</p>
								    <p>We fix your spots in a minute</p>
								</div>
					...
					<li>
						<div class="slider-img-3">
							<div class="slider_banner_info">
								<div class="text">
								  <p style="color:white;font-size:34px;">Our Home Service Providers will Make You Proud in Society</p>
								  <p>We fix your spots in a minute</p>
								</div>
...
<div class="card" >
  ...
  <div class="card-body">
    ...
    <p class="card-text">Get Carpenters near you within 90 minutes with 30-day post-service guarantee and Protection against Damage up to INR 10,000. Fix-It Felix will help you in taking away the pain of finding a trusted Carpenter to cater to your needs, right at the comfort of your home.</p>
    <a href="Carp.jsp" class="btn btn-primary">Explore</a>
  </div>
</div>
</div>
<div class="col-md-4 col-sm-12 w3_ban1">
<div class="card" >
  ...
  <div class="card-body">
    ...
    <p class="card-text">Get Plumbers near you within 90 minutes with 30-day post-service guarantee and Protection against Damage up to INR 10,000. Fix-It Felix will help you in taking away the pain of finding a trusted Carpenter to cater to your needs, right at the comfort of your home.</p>
    <a href="Plumber.jsp" class="btn btn-primary">Explore</a>
  </div>
</div>
</div>
<div class="col-md-4 col-sm-12 w3_ban1">
<div class="card" >
  ...
  <div class="card-body">
    ...
    <p class="card-text">Get Electricians near you within 90 minutes with 30-day post-service guarantee and Protection against Damage up to INR 10,000. Fix-It Felix will help you in taking away the pain of finding a trusted Carpenter to cater to your needs, right at the comfort of your home.</p>
    <a href="Elect.jsp" class="btn btn-primary">Explore</a>
  </div>
</div>
</div>
...
<div class="card" >
  ...
  <div class="card-body">
    ...
    <p class="card-text">Get Welders near you within 90 minutes with 30-day post-service guarantee and Protection against Damage up to INR 10,000. Fix-It Felix will help you in taking away the pain of finding a trusted Carpenter to cater to your needs, right at the comfort of your home.</p>
    <a href="Welder.jsp" class="btn btn-primary">Explore</a>
  </div>
</div>
</div>
<div class="col-md-4 col-sm-12 w3_ban">
<div class="card" >
  ...
  <div class="card-body">
    ...
    <p class="card-text">Get Painters near you within 90 minutes with 30-day post-service guarantee and Protection against Damage up to INR 10,000. Fix-It Felix will help you in taking away the pain of finding a trusted Carpenter to cater to your needs, right at the comfort of your home.</p>
    <a href="Painter.jsp" class="btn btn-primary">Explore</a>
  </div>
</div>
</div>
...
<p>Our mission is to provide door to door services for people and must satisfy their needs...</p>
</div>
	...
	<div class="container"> 
		...
		<div class="col-sm-6 stats_grid_right">
			...
			<div class="skillbar" data-percent="94">
			  <span class="skillbar-title" style="background: #2980b9;">EXTERIORS</span>
...
<div class="w3_mg">
<h3>Fix-It Felix</h3>
<p class=" my-lg-4 my-md-3 my-sm-2 my-2">Fix-It Felix is a one-top solution to sort all your home needs ranging from construction to maintenance,professionally and conveniently...</p>
<!-- Button trigger modal -->

<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" onclick="location.href='Contact.jsp';">
  Contact Page
</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Fix-It Felix</h5>
