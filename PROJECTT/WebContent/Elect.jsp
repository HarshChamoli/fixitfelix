...
<body>
<br>
<h1>&nbsp;Electricians for you...</h1><hr style="height:1px; background-color:#333;"><br>
...
ResultSet rs=stmt.executeQuery("select * from addlabor where workertype='Electrician'");
